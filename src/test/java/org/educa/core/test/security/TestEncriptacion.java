...
public class TestEncriptacion {
	...
	public void testAutenticacionDebePasar(){
		...
		String encryptedPassword = passwordEncryptor.encryptPassword("admin1234");
		System.out.println("admin: " + encryptedPassword);
	...
	public void testAutenticacionDebeFallar(){
		BasicPasswordEncryptor passwordEncryptor = new BasicPasswordEncryptor();
		String encryptedPassword = passwordEncryptor.encryptPassword("eli12345");
		System.out.println("eli: " + encryptedPassword);
	...
	public static void main(String[] args) {
		TestEncriptacion t = new TestEncriptacion();
		t.testAutenticacionDebePasar();
		t.testAutenticacionDebeFallar();
